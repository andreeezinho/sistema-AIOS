        ...
        <div class="row gx-3 mb-5 border-bottom">
            <div class="col-12">
                <ol class="breadcrumb mb-3">
                    ...
                    <li class="breadcrumb-item">Iniciar Venda</li>
                </ol>
            </div>
        </div>

        <div class="row justify-content-center">
            <form action="/vendas/cadastro" method="POST" class="card col-11 col-sm-4 py-2 mt-md-5">
                <?php
                    if(isset($erro)){
                ?>
                ...
                ?>
                <div class="row">
                    <h3 class="text-center my-2"><i class="bi-handbag-fill"></i> Iniciar Venda</h3>
                    <?php 
                        include_once('form.php');
                    ?>
                    <div class="form-group text-center">
                        <a href="/vendas" class="btn btn-secondary mx-1">Cancelar</a>
