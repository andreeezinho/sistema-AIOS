                            ...
                            <div class="modal fade" id="cancelar-<?= $venda->uuid ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content text-dark">
                                        ...
                                        <div class="modal-body">
                                            <p class="my-auto">Deseja cancelar a venda no valor de <b>R$ <?= number_format($venda->total,2,",",".") ?></b>?</p>
                                        </div>

                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                                            <form action="/vendas/<?= $venda->uuid ?>/cancelar" method="POST">
                                                <button type="submit" class="btn btn-danger"><i class="bi-cart-x-fill"></i> Cancelar</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
